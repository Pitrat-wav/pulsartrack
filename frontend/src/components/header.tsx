        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-8">
            <a href="/" className="flex items-center gap-2">
              ...
              <h1 className="text-2xl font-bold text-gray-900">PulsarTrack</h1>
            </a>
            ...
            <nav className="hidden md:flex items-center space-x-6">
              ...
              <a href="/advertiser" className="text-gray-700 hover:text-indigo-600 transition-colors font-medium">
                Advertiser
              </a>
              <a href="/publisher" className="text-gray-700 hover:text-indigo-600 transition-colors font-medium">
                Publisher
              </a>
              <a href="/governance" className="text-gray-700 hover:text-indigo-600 transition-colors font-medium">
                Governance
              </a>
            </nav>
          </div>
